...
story += [simple_steps([
    ...
    ("4. Choose ladder years", "The Ladder Years selector controls the withdrawal-year period shown on screen and in the detailed Bucket Lab Report. Five years means the selected Review Year through four years later for every account; accounts with no withdrawals in that period stay quiet. Full Plan shows the whole remaining ladder."),
